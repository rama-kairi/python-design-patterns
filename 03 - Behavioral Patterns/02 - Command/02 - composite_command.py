...
class TestSuite(unittest.TestCase):
    ...
    def test_transfer_fail(self):
        ...
        self._extracted_from_test_better_tranfer_16(transfer, ba1, ba2)
    ...
    # TODO Rename this here and in `test_transfer_fail` and `test_better_tranfer`
    def _extracted_from_test_better_tranfer_16(
        self, transfer, ba1, ba2
    ):
        transfer.invoke()
